...
export default function ContactUsPage() {
  return (
    <main className='bg-[#F2F2F2] pt-16 px-8 md:pb-20 relative'>
      ...
      <h1 className='text-center mb-12 text-[#333] text-xl md:text-3xl font-black border-b md:border-b-2 border-[#A63F0E] w-[125px] md:w-[250px] md:mb-16 mx-auto'>Contact Us!</h1>
