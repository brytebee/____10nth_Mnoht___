  ...
  return (
    ...
    <div className='pb-60'>
      <p className='flex items-center gap-2 mb-2'>
        ...
        <span className='hidden md:block'>hii@techverse.com</span>
        <span className='md:hidden'>No 209 victoria avenue, lagos state, nigeria</span>
      </p>
      <div className='hidden md:block'>
        <p>
          ...
          <Link href='hii@techverse.com' className=''>hii@techverse.com</Link>
        </p>
        <p>
          <Image src='/svgs/facebook.svg' width={25} height={25} alt='facebook' />
          <Link href='hii@techverse.com' className=''>hii@techverse.com</Link>
        </p>

        <p>
          <Image src='/svgs/instagram.svg' width={25} height={25} alt='instagram' />
          <Link href='hii@techverse.com' className=''>hii@techverse.com</Link>
        </p>

        <p>
          <Image src='/svgs/twitter.svg' width={25} height={25} alt='twitter' />
          <Link href='hii@techverse.com' className=''>hii@techverse.com</Link>
        </p>

        <p>
          <Image src='/svgs/whatsapp.svg' width={25} height={25} alt='linkedin' />
          <Link href='hii@techverse.com' className=''>hii@techverse.com</Link>
        </p>
      </div>
      <p className='flex items-center gap-2 md:hidden'>
        <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 28 28" fill="none">
          <path d="M25.6668 7.00002C25.6668 5.71669 24.6168 4.66669 23.3335 4.66669H4.66683C3.3835 4.66669 2.3335 5.71669 2.3335 7.00002V21C2.3335 22.2834 3.3835 23.3334 4.66683 23.3334H23.3335C24.6168 23.3334 25.6668 22.2834 25.6668 21V7.00002ZM23.3335 7.00002L14.0002 12.8334L4.66683 7.00002H23.3335ZM23.3335 21H4.66683V9.33335L14.0002 15.1667L23.3335 9.33335V21Z" fill="#D97508" />
        </svg>
        <Link href='mailto:hii@techverse.com' className='text-[#D97508] md:text-black'>hii@techverse.com</Link>
      </p>
    </div>
  )
}
