...
const MobileContactDetails = () => (
  <div className='md:hidden'>
    <p className='flex items-center gap-2'>
      ...
      <span className=''>No 209 victoria avenue, lagos state, nigeria</span>
    </p>
    <p className='flex items-center gap-2'>
      ...
      <Link href='mailto:hii@techverse.com' className='text-[#D97508'>hii@techverse.com</Link>
    </p>
  </div>
)
    ...
    <div className='pb-60'>
      <div className='hidden md:flex flex-col gap-3'>
        <p className='flex items-center gap-2'>
          ...
          <span className=''>hii@techverse.com</span>
        </p>

        <p className='flex gap items-center gap-2'>
          <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 28 28" fill="none">
