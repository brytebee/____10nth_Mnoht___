        ...
        <CoursesMobile courses={courses} />
          <div className='px-6 py-9 border border-secondary rounded md:border-none md:px-0 md:border'>
            <div className='flex flex-col gap-9 items-center justify-center'>
              <h4 className='text-body text-lg lg:text-3xl md:text-2xl font-semibold w-[275px] md:text-center lg:w-[911px] md:w-[700px]'>Start as a newbie and become a pro in 6 months and start applying for that dream job</h4>
              <button type="button" className='border-none py-3 px-6 text-white bg-primary rounded-[10px] md:w-[235px]'>Enroll now</button>
            </div>
          </div>
    </section>
  )
