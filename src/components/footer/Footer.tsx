          ...
          <div>
            <div className="flex flex-col gap-[3px] w-full rounded-md relative md:w-[280px] lg:w-[420px]">
              ...
              <div>
                ...
                <button type="button" className="bg-primary text-white text-sm w-[90px] md:w-[100px] py-3 px-3 md:px-1 lg:px-1 lg:w-[100px] rounded-md shadow-[0px 7px 52px 0px] absolute right-1 bottom-0.5 font-bold">Sign up</button>
              </div>
            </div>
            <FooterSocialIcons />
          </div>
